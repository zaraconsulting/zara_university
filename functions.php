...
function university_theme_files()
{
    ...
    if ( strstr($_SERVER['SERVER_NAME'], 'localhost') ) {
        ...
        wp_enqueue_script('main-university-js', get_theme_file_uri('/bundled-assets/scripts.80a5059d2a1cb9221e3e.js'));
        wp_enqueue_style('main-styles', get_theme_file_uri('/bundled-assets/styles.80a5059d2a1cb9221e3e.css'));
    }
